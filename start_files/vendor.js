...
;(function ( $, window, document, undefined ) {
  ...
  Plugin.prototype.renderer = function () {
    ...
    if(template !== ''){  //if there is a template
      ...
      $(this.element).html(
                            '<div class="gbox3"><a class="count" href="#">' + total + '</a>' +
...
(function ($) {
    ...
    function initSocialButtons() {
        var socialJQ = $('.social-icons');

        /* Social share buttons on product page */
        socialJQ.find('.twitter').sharrre({
        ...
        socialJQ.find('.facebook').sharrre({
        ...
        socialJQ.find('.pinterest').sharrre({
        ...
        socialJQ.find('.googleplus').sharrre({
            template: '<button class="btn btn-xs btn-google-plus"><i class="fa fa-google-plus"></i> &nbsp; {total}</button>',
            share: {},
            enableHover: false,
            enableTracking: true,
            click: function (api, options) {
